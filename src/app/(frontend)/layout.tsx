    ...
    return (
        <div className={"w-full min-h-screen bg-background"}>
            <div id="wrapper" className={"bg-surface w-[1320px] mx-auto min-h-screen flex flex-col"}>
                <nav className={"sticky top-0 z-999 w-full p-6 flex justify-between items-center shadow-lg shadow-background bg-surface"}>
                    <div>
                ...
                <footer className={"w-full px-6 py-12 flex flex-col min-h-[500px] shadow-top shadow-background border-t border-background bg-accent-light"}>
                    <div className={"flex-1 flex flex-col gap-12 px-6 mb-32"}>
                        ...
                        <div className={"grid grid-cols-4 gap-6 px-12"}>
                            ...
                            <div className={"flex flex-col gap-8"}>
                                ...
                                <div className={"pl-3 flex flex-col gap-8"}>
                                    ...
                                    <Link href={'/login'}>Advanced</Link>
                                    <Link href={'/register'}>Pro</Link>
                                    <Link href={'/pricing'}>Starter (free)</Link>
                                </div>
                            </div>
                            ...
                            <div className={"flex flex-col gap-8"}>
                                ...
                                <div className={"pl-3 flex flex-col gap-8"}>
                                    ...
                                    <Link href={'/pricing'}>Consider a subscription</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className={"text-secondary text-xs px-6 flex justify-between"}>
                        <p>&copy; {currentYear} ClueForge. All rights reserved.</p>
